        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentProject = table.Column<string>(nullable: true),
                    CurrentUnitNumber = table.Column<string>(nullable: true),
                    Price = table.Column<decimal>(nullable: false),
                    GP = table.Column<decimal>(nullable: false),
                    GPValue = table.Column<decimal>(nullable: false),
                    SIMAH = table.Column<bool>(nullable: false),
                    TypeOfCounterOffers = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    VAS = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationRole_ApplicationPermission_AspNetRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<string>(nullable: true),
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    StubNumber = table.Column<int>(nullable: false),
                    LastName = table.Column<string>(nullable: true),
                    FirstName = table.Column<string>(nullable: true),
